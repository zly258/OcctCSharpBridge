...
public static class DemoLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishUi = new ReadOnlyDictionary<string, string>(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Toolbar.ShadedEdges"] = "Shaded + Edges",
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseUi = new ReadOnlyDictionary<string, string>(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Menu.Create"] = "创建(&C)", ["Menu.Settings"] = "设置(&S)",
            ["Menu.Annotate"] = "注释(&A)", ["Menu.Analyze"] = "分析(&N)", ["Menu.View"] = "视图(&V)", ["Menu.Tools"] = "设置(&S)", ["Menu.Exchange"] = "交换(&X)",
            ["Menu.Samples"] = "案例(&A)", ["Menu.Help"] = "帮助(&H)", ["Menu.Language"] = "语言(&L)", ["Menu.New"] = "新建", ["Menu.Open"] = "打开...", ["Menu.Save"] = "保存",
            ...
            ["Menu.ViewSettings"] = "视图设置...", ["Menu.Exit"] = "退出", ["Menu.Undo"] = "撤销", ["Menu.Redo"] = "重做", ["Menu.ClearSelection"] = "取消全部选择", ["Menu.ShowAll"] = "全部显示",
            ...
            ["Menu.GradientBackground"] = "渐变背景", ["Menu.DepthHandling"] = "深度与共面显示", ["Menu.AutoZFit"] = "自动 Z 范围", ["Menu.AutoZFitNow"] = "重新计算 Z 范围", ["Menu.MouseHelp"] = "鼠标操作", ["Menu.About"] = "关于", ["Menu.English"] = "English",
            ...
            ["Toolbar.Shaded"] = "着色", ["Toolbar.ShadedEdges"] = "着色+边线", ["Toolbar.Wireframe"] = "线框", ["Toolbar.Hlr"] = "消隐", ["Toolbar.FitAll"] = "全图", ["Toolbar.Extents"] = "范围", ["Toolbar.Isometric"] = "轴测",
            ...
            ["Status.WindowSelectionOff"] = "框选已关闭", ["Status.AutoZFitOn"] = "自动 Z 范围调整已启用", ["Status.AutoZFitOff"] = "自动 Z 范围调整已关闭", ["Dialog.OpenTitle"] = "打开图形", ["Dialog.ImportTitle"] = "导入模型", ["Dialog.SaveTitle"] = "保存图形",
    ...
    private static readonly IReadOnlyDictionary<DemoCommandId, (string Text, string Description)> EnglishCommands =
        new ReadOnlyDictionary<DemoCommandId, (string Text, string Description)>(new Dictionary<DemoCommandId, (string, string)>
        {
            ...
            [DemoCommandId.DemoSectionAnalysis] = ("Section Analysis", "Splits a solid by a plane and displays positive, negative, and section results."),
            [DemoCommandId.DemoDrawingProjection] = ("Drawing Projection", "Creates Front, Top, Right, and Isometric HLR engineering projections."),
            [DemoCommandId.DemoDistanceExtrema] = ("Distance & Extrema", "Computes and visualizes curve-to-curve extrema and closest-point segments."),
            [DemoCommandId.DemoModelRepair] = ("Model Repair", "Runs shape healing and compares structured inspection results before and after repair."),
...
["precision"] = "Precision", ["maxTolerance"] = "Maximum Tolerance",
