...
public sealed partial class OcctAvaloniaViewport
{
    ...
    private const nuint X11CurrentTime = 0;

    private const nuint XkBackSpace = 0xFF08;
    private const nuint XkTab = 0xFF09;
    private const nuint XkReturn = 0xFF0D;
    private const nuint XkEscape = 0xFF1B;
    private const nuint XkHome = 0xFF50;
    private const nuint XkLeft = 0xFF51;
    private const nuint XkUp = 0xFF52;
    private const nuint XkRight = 0xFF53;
    private const nuint XkDown = 0xFF54;
    private const nuint XkPageUp = 0xFF55;
    private const nuint XkPageDown = 0xFF56;
    private const nuint XkEnd = 0xFF57;
    private const nuint XkInsert = 0xFF63;
    private const nuint XkF1 = 0xFFBE;
    private const nuint XkF12 = 0xFFC9;
    private const nuint XkShiftL = 0xFFE1;
    private const nuint XkShiftR = 0xFFE2;
    private const nuint XkControlL = 0xFFE3;
    private const nuint XkControlR = 0xFFE4;
    private const nuint XkMetaL = 0xFFE7;
    private const nuint XkMetaR = 0xFFE8;
    private const nuint XkAltL = 0xFFE9;
    private const nuint XkAltR = 0xFFEA;
    private const nuint XkDelete = 0xFFFF;
