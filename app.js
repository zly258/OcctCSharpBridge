const translations = {
  en: {
    ...
    demoBranchText:'Windows demo consumer for the published main SDK. Contains Common, WinForms and WPF demos only; Avalonia projects remain on the dedicated avalonia branch.',
  ...
  zh: {
    ...
    mainText:'Windows 源码与 Binary SDK 生产分支。公开程序集为 OcctNet、OcctNet.WinForms、OcctNet.Wpf；契约 419/419、139 个公开类型、net10.0-windows。',
    avaloniaText:'独立跨平台源码，使用 OcctNet + OcctNet.Avalonia，通过同一套 API 支持 Windows x64 + Linux x64；契约 420/420、135 个公开类型、net10.0。',
    demoBranchText:'消费 main 已发布 Windows SDK 的 Demo 分支，只保留 Common、WinForms、WPF；Avalonia 项目继续独立维护在 avalonia 分支。',
    ...
    f8Title:'跨平台 Avalonia', f8Text:'avalonia 只公开一个 OcctAvaloniaViewport。Windows 内部使用 HWND/WNT_Window；Linux 使用 X11/XWayland XID/Xw_Window，并通过原生子窗口输入和 Motion 合并处理鼠标交互。',
