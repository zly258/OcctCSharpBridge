...
Assert-Contains "src/OcctNative/OcctViewCube.cpp" "V3d_TypeOfOrientation_Zup_Front"
Assert-Contains "src/OcctNative/OcctViewCube.cpp" "Microsoft YaHei UI"
Assert-Contains "src/OcctNet/OcctEngine.Viewport.cs" "SetViewCubeLanguage"
...
$utf8BomFiles = @(
    ...
    "src/OcctNative/OcctViewCube.cpp",
    "src/OcctNet/OcctViewportTypes.cs",
    "src/OcctNet/ViewportNativeMethods.cs",
