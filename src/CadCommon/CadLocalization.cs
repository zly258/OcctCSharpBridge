...
public static class CadLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseUi = new ReadOnlyDictionary<string, string>(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Menu.GradientBackground"] = "渐变背景", ["Menu.MouseHelp"] = "鼠标操作", ["Menu.About"] = "关于", ["Menu.English"] = "English",
            ...
            ["Status.WindowSelectionOff"] = "框选已关闭", ["Dialog.OpenTitle"] = "打开图形", ["Dialog.ImportTitle"] = "导入模型", ["Dialog.SaveTitle"] = "保存图形",
