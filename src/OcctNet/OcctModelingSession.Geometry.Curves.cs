...
public sealed partial class OcctModelingSession
{
    public OcctModelShape MakeVertex(OcctPoint3d point)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_vertex(NativeHandle, point, out var result);
    ...
    public OcctModelShape MakeLine(OcctPoint3d start, OcctPoint3d end)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_line(NativeHandle, start, end, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakePolyline(IEnumerable<OcctPoint3d> points, bool closed = false)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_polyline(NativeHandle, array, array.Length, closed ? 1 : 0, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeCircle(OcctPoint3d center, OcctVector3d normal, double radius)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_circle(NativeHandle, center, normal, radius, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeArc(OcctPoint3d start, OcctPoint3d middle, OcctPoint3d end)
    {
        ...
        OcctGuard.Finite(end, nameof(end));
        var status = ModelNativeMethods.occt_model_make_arc_three_points(NativeHandle, start, middle, end, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeArc(OcctPoint3d center, OcctVector3d normal, OcctVector3d xDirection, double radius, double startAngleDegrees, double endAngleDegrees)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_arc_center(
            NativeHandle, center, normal, xDirection, radius, startAngleDegrees, endAngleDegrees, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeEllipse(OcctPoint3d center, OcctVector3d normal, double majorRadius, double minorRadius)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_ellipse(NativeHandle, center, normal, majorRadius, minorRadius, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeBezier(IEnumerable<OcctPoint3d> poles)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_bezier(NativeHandle, array, array.Length, out var result);
        return CheckShape(status, result);
    }
    ...
    public OcctModelShape MakeInterpolatedBSpline(IEnumerable<OcctPoint3d> points, bool periodic = false, double tolerance = 1e-7)
    {
        ...
        var status = ModelNativeMethods.occt_model_make_bspline_interpolated(
            NativeHandle, array, array.Length, periodic ? 1 : 0, tolerance, out var result);
        return CheckShape(status, result);
    }
}
