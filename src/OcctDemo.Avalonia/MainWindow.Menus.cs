...
public sealed partial class MainWindow
{
    private void BuildMenus()
    {
        var file = Menu(MenuHeader("Menu.File"),
            MenuItem(DemoLocalization.Text("Menu.New"), NewDocument, Shortcut(Key.N, KeyModifiers.Control)),
            MenuItem(DemoLocalization.Text("Menu.Open"), OpenDocument, Shortcut(Key.O, KeyModifiers.Control)),
            MenuItem(DemoLocalization.Text("Menu.Save"), () => SaveDocument(false), Shortcut(Key.S, KeyModifiers.Control)),
            MenuItem(DemoLocalization.Text("Menu.SaveAs"), () => SaveDocument(true), Shortcut(Key.S, KeyModifiers.Control | KeyModifiers.Shift)),
            new Separator(),
            MenuItem(DemoLocalization.Text("Menu.Import"), ImportDocument),
            MenuItem(DemoLocalization.Text("Menu.ExportSelected"), ExportSelected),
            MenuItem(DemoLocalization.Text("Menu.ExportImage"), ExportViewImage),
            new Separator(),
        ...
        var help = Menu(MenuHeader("Menu.Help"),
            MenuItem(DemoLocalization.Text("Menu.MouseHelp"), ShowMouseHelp),
            MenuItem(DemoLocalization.Text("Menu.About"), ShowAbout));
    ...
    private MenuItem BuildViewMenu()
    {
        ...
        return Menu(MenuHeader("Menu.View"),
            ...
            MenuItem(DemoLocalization.Text("Menu.Background"), SetBackgroundColor),
    ...
    private void BuildToolbar()
    {
        ...
        _toolbar.Children.Add(ToolButton(DemoLocalization.Text("Toolbar.New"), NewDocument));
        _toolbar.Children.Add(ToolButton(DemoLocalization.Text("Toolbar.Open"), OpenDocument));
        _toolbar.Children.Add(ToolButton(DemoLocalization.Text("Toolbar.Save"), () => SaveDocument(false)));
