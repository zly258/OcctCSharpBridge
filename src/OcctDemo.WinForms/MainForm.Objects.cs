...
public sealed partial class MainForm
{
    ...
    private void RefreshObjectTree()
    {
        ...
        _selectionStatus.Text = DemoLocalization.CurrentLanguage == DemoLanguage.ChineseSimplified ? $"对象 {Session.Engine.ObjectCount} / 形体 {Session.Engine.ShapeCount}" : $"Objects {Session.Engine.ObjectCount} / Shapes {Session.Engine.ShapeCount}";
    }
    ...
    private void ObjectTreeAfterSelect(object? sender, TreeViewEventArgs e)
    {
        ...
        _selectionStatus.Text = DemoLocalization.CurrentLanguage == DemoLanguage.ChineseSimplified ? $"当前：{Session.SafeName(value)}" : $"Current: {Session.SafeName(value)}";
    }
