...
internal static partial class ModelNativeMethods
{
    ...
    internal static partial OcctStatus occt_model_history_summary(OcctModelingSafeHandle handle, long operationId, long sourceShapeId, out NativeModelTopologyHistorySummary result);
}
