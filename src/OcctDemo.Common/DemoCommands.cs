...
public static class DemoCommandCatalog
{
    ...
    public static IReadOnlyList<DemoCommandDefinition> All { get; } = new DemoCommandDefinition[]
    {
        ...
        new(DemoCommandId.Text, "注释", "矢量文字", "生成可缩放的 BRep 矢量文字，放大后保持清晰。", new[] { T("text","文字","OCCT CAD"), N("x","X",0), N("y","Y",0), N("z","Z",0), N("height","文字高度",18), N("depth","挤出厚度",0), T("font","字体",DemoFonts.OcctSansSerif), B("bold","粗体",false), B("italic","斜体",false) }),
        new(DemoCommandId.LengthDimension, "注释", "矢量线性尺寸", "将尺寸线、箭头和文字生成一个 BRep 结果。", new[] { N("flyout","引出距离",20), N("textHeight","文字高度",8), N("arrowSize","箭头大小",5), T("font","字体",DemoFonts.OcctSansSerif) }),
        new(DemoCommandId.AngleDimension, "注释", "矢量角度尺寸", "将圆弧、箭头和文字生成一个 BRep 结果。", new[] { N("flyout","圆弧半径",30), N("textHeight","文字高度",8), N("arrowSize","箭头大小",5), T("font","字体",DemoFonts.OcctSansSerif) }),
        new(DemoCommandId.RadiusDimension, "注释", "矢量半径尺寸", "将引线、箭头和文字生成一个 BRep 结果。", new[] { N("flyout","引出距离",20), N("textHeight","文字高度",8), N("arrowSize","箭头大小",5), T("font","字体",DemoFonts.OcctSansSerif) }),
        new(DemoCommandId.DiameterDimension, "注释", "矢量直径尺寸", "将尺寸线、箭头和文字生成一个 BRep 结果。", new[] { N("flyout","引出距离",20), N("textHeight","文字高度",8), N("arrowSize","箭头大小",5), T("font","字体",DemoFonts.OcctSansSerif) }),
