...
internal sealed class ParameterDialog : System.Windows.Window
{
    ...
    private ParameterDialog(string title, IReadOnlyList<CadParameterDefinition> parameters)
    {
        ...
        ShowInTaskbar = false;
        FontFamily = new System.Windows.Media.FontFamily(CadLocalization.CurrentLanguage == CadLanguage.ChineseSimplified ? "Microsoft YaHei UI" : "Segoe UI");
        FontSize = 13;
        ...
        var ok = new System.Windows.Controls.Button { Content = CadLocalization.Text("Dialog.Ok"), Width = 86, IsDefault = true, Margin = new System.Windows.Thickness(4) };
        var cancel = new System.Windows.Controls.Button { Content = CadLocalization.Text("Dialog.Cancel"), Width = 86, IsCancel = true, Margin = new System.Windows.Thickness(4) };
    ...
    public static bool TryGetValues(System.Windows.Window owner, string title, IReadOnlyList<CadParameterDefinition> parameters, out IReadOnlyDictionary<string, string> values)
    {
    ...
    private static System.Windows.Controls.Control CreateEditor(CadParameterDefinition parameter)
    {
        return parameter.Kind switch
        {
            CadParameterKind.Boolean => new System.Windows.Controls.CheckBox { IsChecked = string.Equals(parameter.DefaultValue, "true", StringComparison.OrdinalIgnoreCase), VerticalContentAlignment = System.Windows.VerticalAlignment.Center },
            CadParameterKind.Choice => new System.Windows.Controls.ComboBox { ItemsSource = parameter.Options ?? Array.Empty<string>(), SelectedItem = parameter.DefaultValue },
