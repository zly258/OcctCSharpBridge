...
public sealed partial class OcctEngine
{
    public OcctShape MakeVertex(OcctPoint3d point)
    {
        ...
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_vertex_create(_handle, point, out var result);
    ...
    public OcctShape MakeLine(OcctPoint3d start, OcctPoint3d end)
    {
        ...
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_line_create(_handle, start, end, out var result);
        return GeometryResult(status, result);
    }
    ...
    public OcctShape MakePolyline(IEnumerable<OcctPoint3d> points, bool closed = false)
    {
        ...
        return CreateGeometryFromPoints(
            array,
            (IntPtr buffer, int count, out long result) => ViewerGeometryCreationNativeMethods.occt_engine_shape_polyline_create(
                _handle,
                buffer,
                count,
                closed ? 1 : 0,
    ...
    public OcctShape MakeCircle(OcctPoint3d center, OcctVector3d normal, double radius)
    {
        ...
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_circle_create(
            _handle,
            center,
            normal,
            radius,
    ...
    public OcctShape MakeArc(OcctPoint3d start, OcctPoint3d middle, OcctPoint3d end)
    {
        ...
        OcctGuard.Finite(end, nameof(end));
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_arc_three_points_create(
            _handle,
            start,
            middle,
            end,
        ...
        double endAngleDegrees)
    {
        ...
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_arc_center_create(
            _handle,
            center,
            normal,
            xDirection,
    ...
    public OcctShape MakeEllipse(OcctPoint3d center, OcctVector3d normal, double majorRadius, double minorRadius)
    {
        ...
        EnsureInitialized();
        var status = ViewerGeometryCreationNativeMethods.occt_engine_shape_ellipse_create(
            _handle,
            center,
            normal,
            majorRadius,
    ...
    public OcctShape MakeBezier(IEnumerable<OcctPoint3d> poles)
    {
        ...
        return CreateGeometryFromPoints(
            array,
            (IntPtr buffer, int count, out long result) => ViewerGeometryCreationNativeMethods.occt_engine_shape_bezier_create(
                _handle,
                buffer,
                count,
                out result));
    ...
    public OcctShape MakeInterpolatedBSpline(
        ...
        double tolerance = 1e-7)
    {
        ...
        return CreateGeometryFromPoints(
            array,
            (IntPtr buffer, int count, out long result) => ViewerGeometryCreationNativeMethods.occt_engine_shape_bspline_interpolated_create(
                _handle,
                buffer,
                count,
                periodic ? 1 : 0,
