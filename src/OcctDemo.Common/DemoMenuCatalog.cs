...
public static class DemoMenuCatalog
{
    ...
    private static DemoMenuItemDefinition Submenu(
        string textKey,
        params DemoMenuItemDefinition[] items) =>
        new(DemoMenuItemKind.Submenu, textKey, Children: items);
    ...
    [
        Menu("Menu.File",
            ...
            Submenu("Menu.Export",
                ...
                Action("Menu.ExportImage", DemoMenuAction.ExportViewImage),
                Separator(),
                Action("Menu.ExportObj", DemoMenuAction.ExportObj),
                Action("Menu.ExportGltf", DemoMenuAction.ExportGltf),
                Action("Menu.ExportStlBatch", DemoMenuAction.ExportStl)),
            Separator(),
