...
public sealed partial class OcctEngine
{
    ...
    public OcctShape MakeLengthAnnotationShape(
        OcctShape edge,
        double flyout = 20,
        double textHeight = 8,
        double arrowSize = 5,
    ...
    public OcctShape MakeAngleAnnotationShape(
        OcctShape firstEdge,
    ...
    public OcctShape MakeRadiusAnnotationShape(
        OcctShape circularEdge,
        double flyout = 20,
        double textHeight = 8,
        double arrowSize = 5,
        string? fontName = null)
    ...
    public OcctShape MakeDiameterAnnotationShape(
        OcctShape circularEdge,
        double flyout = 20,
        double textHeight = 8,
        double arrowSize = 5,
