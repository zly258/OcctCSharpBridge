...
internal static partial class ModelNativeMethods
{
    ...
    internal static extern int occt_model_project_point_on_edge(IntPtr handle, long edgeId, OcctPoint3d point, out OcctModelProjectionResult result);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    internal static extern int occt_model_project_point_on_face(IntPtr handle, long faceId, OcctPoint3d point, out OcctModelProjectionResult result);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true)]
    internal static extern int occt_model_ray_intersections(
        IntPtr handle,
        long shapeId,
        OcctPoint3d origin,
