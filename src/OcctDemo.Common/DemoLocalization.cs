...
public static class DemoLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> EnglishUi = new ReadOnlyDictionary<string, string>(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Menu.TestObjGltfExchange"] = "OBJ / glTF Exchange Test",
            ["Menu.New"] = "New",
            ["Menu.Open"] = "Open...",
            ["Menu.Save"] = "Save",
            ["Menu.SaveAs"] = "Save As...",
            ...
            ["Menu.ExportObj"] = "Export OBJ...",
            ["Menu.ExportGltf"] = "Export glTF...",
            ["Menu.ExportStlBatch"] = "Batch Export STL...",
            ["Menu.ObjGltfExchangeTest"] = "OBJ / glTF Exchange Test",
            ["Menu.Exit"] = "Exit",
            ["Menu.Undo"] = "Undo",
            ["Menu.Redo"] = "Redo",
    ...
    private static readonly IReadOnlyDictionary<string, string> ChineseUi = new ReadOnlyDictionary<string, string>(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Menu.Annotate"] = "注释(&A)", ["Menu.View"] = "视图(&V)", ["Menu.Tools"] = "工具(&T)", ["Menu.Exchange"] = "交换(&X)",
            ...
            ["Menu.TestCurveFit"] = "B 样条曲线拟合测试", ["Menu.TestPipeShell"] = "PipeShell 高级扫掠测试",
            ["Menu.TestEdgeIntersection"] = "几何边求交测试", ["Menu.TestObjGltfExchange"] = "OBJ / glTF 交换测试",
            ["Menu.SaveAs"] = "另存为...", ["Menu.Import"] = "导入...", ["Menu.ExportSelected"] = "导出选中对象...", ["Menu.ExportImage"] = "导出视图图片...",
            ["Menu.ExportObj"] = "OBJ 导出...", ["Menu.ExportGltf"] = "glTF 导出...", ["Menu.ExportStlBatch"] = "STL 批量导出...",
            ["Menu.ObjGltfExchangeTest"] = "OBJ / glTF 数据交换测试",
